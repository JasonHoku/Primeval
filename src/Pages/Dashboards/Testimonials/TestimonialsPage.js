...
export default class ContactElements extends Component {
  ...
  submitContact() {
    ...
    if (
      ...
      var templateParams = {
        name: `MauiVisions Submission From: ${CLIIP}`,
              ...
              <Col md="12" lg="5" xl="4">
                <Card>
                  ...
                  >
                    ...
                    >
                      <h1>
                        <span className="capsVar">M</span>aui
                        <span className="capsVar">A</span>rt
                        <span className="capsVar">P</span>rints{" "}
                        <span className="capsVar">T</span>estimonials
                      </h1>
                    </CardTitle>
                    <CardImg src="/images/testimonies.jpg"></CardImg>
                  </CardBody>
                </Card>{" "}
                <br />
              </Col>
              <Col md="9" lg="6" xl="5">
                ...
                >
                  <CardBody style={{ textAlign: "center" }}>
                    ...
                    >
                      <h1>
                        Reach <span className="capsVar">M</span>aui
                        <span className="capsVar">A</span>rt
                        <span className="capsVar">P</span>rints
                      </h1>
                    </CardTitle>
                    ...
                    <p>
                      ...
                      <a
                        ...
                        href="mailto:info@Primeval.js.com"
                      >
                        info@Primeval.js.com
                      </a>
                      , or through this simple contact form to connect with
                      administration.
                    </p>
